...
public class Corrida extends JFrame implements ActionListener {
	...
	private ImageIcon cavalo1;
	private ImageIcon cavalo2;
	private ImageIcon cavalo3;
	...
	public Corrida() {
		...
		velocimetro = new ImageIcon("./src/ExercicioDois/velocimetro.gif");
		pista = new ImageIcon("./src/ExercicioDois/pista.png");
		...
		cavalo1 = new ImageIcon("./src/ExercicioDois/carro1.png");
		cavalo2 = new ImageIcon("./src/ExercicioDois/carro2.png");
		cavalo3 = new ImageIcon("./src/ExercicioDois/carro3.png");
	...
	public JLabel JLabelCarros(String nome, int posX, int posY) {
		Cavalos cavalo = new Cavalos(nome, posX, posY);
	...
	public void actionPerformed(ActionEvent dispara) {
		if (dispara.getSource() == this.btnCorrida) {
			this.lblPista.add(JLabelCarros("Carro1", 0, 50));
			this.lblPista.add(JLabelCarros("Carro1", 0, 200));
			this.lblPista.add(JLabelCarros("Carro1", 0, 350));
		}
